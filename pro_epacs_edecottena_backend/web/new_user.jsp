<%-- 
    Document   : new_user
    Created on : Feb 16, 2018, 2:59:39 PM
    Author     : Buddhi
--%>


<%
    HttpSession httpSession_new_user = request.getSession();
    httpSession_new_user.setAttribute("page_title", "new_user");
%>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label for="single-select">Role</label>
